...
export default function Home() {
  ...
  return (
      <div>
        <Header/>
        <div className="flex w-full justify-center px-[50px] py-[20px] mb-[85px] space-x-[20px]">
          <form 
            action=""
            className="w-full w-max-[800px] w-min-[400px] flex flex-col space-y-[20px]"
          >
            ...
            <Section title="Payslip/ Payroll Details">
              <div className="flex space-x-[12px]">
                <FormField
                  name="periodType"
                  label="Period Type"
